setwd("~/GitHub/LongMortalityTables/data-raw/2015VBT/2015VBT_RR_ANB")
...
VBT2015_ANB_RR_Select <- bind_rows(all_select) %>%
...
VBT2015_ANB_RR_Ultimate <- bind_rows(all_ultimate) %>%
  mutate(attained_age = as.integer(attained_age), q_ult = as.double(q_ult))

usethis::use_data(VBT2015_ANB_RR_Select)
usethis::use_data(VBT2015_ANB_RR_Ultimate)
readr::write_csv(VBT2015_ANB_RR_Select, "~/GitHub/LongMortalityTables/final-data-csv/2015VBT/2015VBT_RR_ANB/2015VBT_RR_ANB_Select.csv")
readr::write_csv(VBT2015_ANB_RR_Ultimate, "~/GitHub/LongMortalityTables/final-data-csv/2015VBT/2015VBT_RR_ANB/2015VBT_RR_ANB_Ultimate.csv")
...
VBT2015_ANB_RR_Combined <- combineSelectUltimate(VBT2015_ANB_RR_Select, VBT2015_ANB_RR_Ultimate)

usethis::use_data(VBT2015_ANB_RR_Combined)
readr::write_csv(VBT2015_ANB_RR_Combined, "~/GitHub/LongMortalityTables/final-data-csv/2015VBT/2015VBT_RR_ANB/2015VBT_RR_ANB_Combined.csv")
