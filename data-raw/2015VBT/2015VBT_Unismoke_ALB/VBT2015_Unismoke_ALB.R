setwd("~/GitHub/LongMortalityTables/data-raw/2015VBT/2015VBT_Unismoke_ALB")
...
VBT2015_ALB_Unismoke_Select <- bind_rows(all_select) %>%
...
VBT2015_ALB_Unismoke_Ultimate <- bind_rows(all_ultimate) %>%
  mutate(attained_age = as.integer(attained_age), q_ult = as.double(q_ult))

usethis::use_data(VBT2015_ALB_Unismoke_Select)
usethis::use_data(VBT2015_ALB_Unismoke_Ultimate)
readr::write_csv(VBT2015_ALB_Unismoke_Select, "~/GitHub/LongMortalityTables/final-data-csv/2015VBT/2015VBT_Unismoke_ALB/2015VBT_Unismoke_ALB_Select.csv")
readr::write_csv(VBT2015_ALB_Unismoke_Ultimate, "~/GitHub/LongMortalityTables/final-data-csv/2015VBT/2015VBT_Unismoke_ALB/2015VBT_Unismoke_ALB_Ultimate.csv")
...
VBT2015_ALB_Unismoke_Combined <- combineSelectUltimate(VBT2015_ALB_Unismoke_Select, VBT2015_ALB_Unismoke_Ultimate)

usethis::use_data(VBT2015_ALB_Unismoke_Combined)
readr::write_csv(VBT2015_ALB_Unismoke_Combined, "~/GitHub/LongMortalityTables/final-data-csv/2015VBT/2015VBT_Unismoke_ALB/2015VBT_Unismoke_ALB_Combined.csv")
