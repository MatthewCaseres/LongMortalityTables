setwd("~/GitHub/LongMortalityTables/data-raw/2015VBT/2015VBT_SmokerDistinct_ALB")
...
VBT2015_ALB_SmokerDistinct_Select <- bind_rows(all_select) %>%
...
VBT2015_ALB_SmokerDistinct_Ultimate <- bind_rows(all_ultimate) %>%
  mutate(attained_age = as.integer(attained_age), q_ult = as.double(q_ult))

usethis::use_data(VBT2015_ALB_SmokerDistinct_Select)
usethis::use_data(VBT2015_ALB_SmokerDistinct_Ultimate)
readr::write_csv(VBT2015_ALB_SmokerDistinct_Select, "~/GitHub/LongMortalityTables/final-data-csv/2015VBT/2015VBT_SmokerDistinct_ALB/2015VBT_SmokerDistinct_ALB_Select.csv")
readr::write_csv(VBT2015_ALB_SmokerDistinct_Ultimate, "~/GitHub/LongMortalityTables/final-data-csv/2015VBT/2015VBT_SmokerDistinct_ALB/2015VBT_SmokerDistinct_ALB_Ultimate.csv")
...
VBT2015_ALB_SmokerDistinct_Combined <- combineSelectUltimate(VBT2015_ALB_SmokerDistinct_Select, VBT2015_ALB_SmokerDistinct_Ultimate)

usethis::use_data(VBT2015_ALB_SmokerDistinct_Combined)
readr::write_csv(VBT2015_ALB_SmokerDistinct_Combined, "~/GitHub/LongMortalityTables/final-data-csv/2015VBT/2015VBT_SmokerDistinct_ALB/2015VBT_SmokerDistinct_ALB_Combined.csv")
