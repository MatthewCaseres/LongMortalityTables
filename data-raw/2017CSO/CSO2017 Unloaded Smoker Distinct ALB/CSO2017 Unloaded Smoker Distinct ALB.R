setwd("~/GitHub/LongMortalityTables/data-raw/2017CSO/CSO2017 Unloaded Smoker Distinct ALB")
...
CSO2017_Unloaded_SmokerDistinct_Select_ALB <- bind_rows(all_select) %>%
...
CSO2017_Unloaded_SmokerDistinct_Ultimate_ALB <- bind_rows(all_ultimate) %>%
  mutate(attained_age = as.integer(attained_age), q_ult = as.double(q_ult))

usethis::use_data(CSO2017_Unloaded_SmokerDistinct_Select_ALB)
usethis::use_data(CSO2017_Unloaded_SmokerDistinct_Ultimate_ALB)
readr::write_csv(CSO2017_Unloaded_SmokerDistinct_Select_ALB, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Unloaded Smoker Distinct ALB/2017CSO Unloaded Smoker Distinct ALB Select.csv")
readr::write_csv(CSO2017_Unloaded_SmokerDistinct_Ultimate_ALB, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Unloaded Smoker Distinct ALB/2017CSO Unloaded Smoker Distinct ALB Ultimate.csv")
...
CSO2017_Unloaded_SmokerDistinct_ALB_Combined <- combineSelectUltimate(CSO2017_Unloaded_SmokerDistinct_Select_ALB, CSO2017_Unloaded_SmokerDistinct_Ultimate_ALB)

usethis::use_data(CSO2017_Unloaded_SmokerDistinct_ALB_Combined)
readr::write_csv(CSO2017_Unloaded_SmokerDistinct_ALB_Combined, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Unloaded Smoker Distinct ALB/2017CSO Unloaded Smoker Distinct ALB Combined.csv")
