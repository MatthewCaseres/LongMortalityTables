setwd("~/GitHub/LongMortalityTables/data-raw/2017CSO/CSO2017 Unloaded Composite ANB")
...
CSO2017_Unloaded_Composite_ANB_Select <- bind_rows(all_select) %>%
...
CSO2017_Unloaded_Composite_ANB_Ultimate <- bind_rows(all_ultimate) %>%
