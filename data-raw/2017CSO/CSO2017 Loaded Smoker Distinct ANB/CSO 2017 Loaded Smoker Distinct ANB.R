setwd("~/GitHub/LongMortalityTables/data-raw/2017CSO/CSO2017 Loaded Smoker Distinct ANB")
...
CSO2017_Loaded_SmokerDistinct_Select_ANB <- bind_rows(all_select) %>%
...
CSO2017_Loaded_SmokerDistinct_Ultimate_ANB <- bind_rows(all_ultimate) %>%
  mutate(attained_age = as.integer(attained_age), q_ult = as.double(q_ult))

usethis::use_data(CSO2017_Loaded_SmokerDistinct_Select_ANB)
usethis::use_data(CSO2017_Loaded_SmokerDistinct_Ultimate_ANB)
readr::write_csv(CSO2017_Loaded_SmokerDistinct_Select_ANB, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Loaded Smoker Distinct ANB/2017CSO Loaded Smoker Distinct ANB Select.csv")
readr::write_csv(CSO2017_Loaded_SmokerDistinct_Ultimate_ANB, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Loaded Smoker Distinct ANB/2017CSO Loaded Smoker Distinct ANB Ultimate.csv")
...
CSO2017_Loaded_SmokerDistinct_ANB_Combined <- combineSelectUltimate(CSO2017_Loaded_SmokerDistinct_Select_ANB, CSO2017_Loaded_SmokerDistinct_Ultimate_ANB)

usethis::use_data(CSO2017_Loaded_SmokerDistinct_ANB_Combined)
readr::write_csv(CSO2017_Loaded_SmokerDistinct_ANB_Combined, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Loaded Smoker Distinct ANB/2017CSO Loaded Smoker Distinct ANB Combined.csv")
