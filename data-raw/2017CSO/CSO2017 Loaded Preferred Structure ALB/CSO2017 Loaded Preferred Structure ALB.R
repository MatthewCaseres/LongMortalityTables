setwd("~/GitHub/LongMortalityTables/data-raw/2017CSO/CSO2017 Loaded Preferred Structure ALB")
...
CSO2017_Loaded_PreferredStructure_ALB_Select <- bind_rows(all_select) %>%
...
CSO2017_Loaded_PreferredStructure_ALB_Ultimate <- bind_rows(all_ultimate) %>%
