...
readr::write_csv(CSO2017_Loaded_SmokerDistinct_GenderBlend_ALB_Select, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Loaded Smoker Distinct Gender Blended ALB/2017CSO Loaded Smoker Distinct Gender Blended ALB Select.csv")
readr::write_csv(CSO2017_Loaded_SmokerDistinct_GenderBlend_ALB_Ultimate, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Loaded Smoker Distinct Gender Blended ALB/2017CSO Loaded Smoker Distinct Gender Blended ALB Ultimate.csv")
...
CSO2017_Loaded_SmokerDistinct_GenderBlend_ALB_Combined <- combineSelectUltimate(CSO2017_Loaded_SmokerDistinct_GenderBlend_ALB_Select, CSO2017_Loaded_SmokerDistinct_GenderBlend_ALB_Ultimate)

usethis::use_data(CSO2017_Loaded_SmokerDistinct_GenderBlend_ALB_Combined)
readr::write_csv(CSO2017_Loaded_SmokerDistinct_GenderBlend_ALB_Combined, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Loaded Smoker Distinct Gender Blended ALB/2017CSO Loaded Smoker Distinct Gender Blended ALB Combined.csv")
