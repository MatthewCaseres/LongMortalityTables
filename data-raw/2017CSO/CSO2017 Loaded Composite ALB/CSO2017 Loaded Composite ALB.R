setwd("~/GitHub/LongMortalityTables/data-raw/2017CSO/CSO2017 Loaded Composite ALB")
...
CSO2017_Loaded_Composite_ALB_Select <- bind_rows(all_select) %>%
...
CSO2017_Loaded_Composite_ALB_Ultimate <- bind_rows(all_ultimate) %>%
  mutate(attained_age = as.integer(attained_age), q_ult = as.double(q_ult))

usethis::use_data(CSO2017_Loaded_Composite_ALB_Select)
usethis::use_data(CSO2017_Loaded_Composite_ALB_Ultimate)
readr::write_csv(CSO2017_Loaded_Composite_ALB_Select, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Loaded Composite ALB/2017CSO Loaded Composite ALB Select.csv")
readr::write_csv(CSO2017_Loaded_Composite_ALB_Ultimate, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Loaded Composite ALB/2017CSO Loaded Composite ALB Ultimate.csv")
...
CSO2017_Loaded_Composite_ALB_Combined <- combineSelectUltimate(CSO2017_Loaded_Composite_ALB_Select, CSO2017_Loaded_Composite_ALB_Ultimate)

usethis::use_data(CSO2017_Loaded_Composite_ALB_Combined)
readr::write_csv(CSO2017_Loaded_Composite_ALB_Combined, "~/GitHub/LongMortalityTables/final-data-csv/2017CSO/2017CSO Loaded Composite ALB/2017CSO Loaded Composite ALB Combined.csv")
